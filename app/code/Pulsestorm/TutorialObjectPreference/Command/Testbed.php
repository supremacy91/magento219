...
class Testbed extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $cl1 = $this->object_manager->get('Pulsestorm\TutorialObjectPreference\Command\Class1');
     //   $cl =  \Pulsestorm\TutorialObjectPreference\Command\Class1::getMessage();
        //var_dump(get_class($cl));
    }
} 